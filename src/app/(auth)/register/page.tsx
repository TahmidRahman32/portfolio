...
export default function RegisterPage() {
   ...
   return (
      <div className="min-h-screen  flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-[#745150] dark:bg-[#4b1614]">
         <div className="sm:mx-auto sm:w-full sm:max-w-md">
            <h2 className="mt-6 text-center text-3xl font-extrabold text-white">Create your account</h2>
            <p className="mt-2 text-center text-sm text-white">
               Already have an account?{" "}
               <a href="/login" className="font-medium text-blue-700 px-3 text-center py-1  rounded-4xl bg-white hover:text-purple-500">
                  Sign in
               </a>
            </p>
         </div>
               ...
               <div className="mt-6">
                  <div className="relative">
                     ...
                     <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-accent-foreground rounded-4xl text-accent">Or register with email</span>
                     </div>
                  </div>
               </div>
                           ...
                           <div>
                              ...
                              <div className="mt-1">
                                 <input
                                    ...
                                    className={`appearance-none text-gray-900 block w-full px-3 py-2 border rounded-md shadow-sm placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-1 sm:text-sm ${
                           ...
                           <div>
                              ...
                              <div className="mt-1">
                                 <input
                                    ...
                                    className={`appearance-none text-gray-800 block w-full px-3 py-2 border rounded-md shadow-sm placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-1 sm:text-sm ${
                                       fieldState.invalid ? "border-red-300 focus:ring-red-500 focus:border-red-500" : "border-gray-300 focus:ring-purple-500 focus:border-purple-500"
                                    }`}
                                    placeholder="Doe"
                                 />
