...
export default function LoginPage() {
   ...
   return (
      <div className="min-h-screen  flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-[#4b1614] dark:bg-[#4b1614]">
         <div className="sm:mx-auto sm:w-full sm:max-w-md">
            <h2 className="mt-6 text-center text-3xl font-extrabold text-white">Welcome back</h2>
            <p className="mt-2 text-center text-sm text-white">
               Don't have an account?{" "}
               <a href="register" className="font-medium text-yellow-400 hover:text-indigo-500 ">
                  Sign up
               </a>
            </p>
         </div>
               ...
               <div className="mt-6">
                  <div className="relative">
                     ...
                     <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-accent-foreground rounded-4xl text-gray-500">Or continue with email</span>
                     </div>
                  </div>
               </div>
                        ...
                        <div>
                           ...
                           <div className="mt-1">
                              <input
                                 ...
                                 type="email"
                                 autoComplete="email"
                                 className={`appearance-none block w-full px-3 py-2 border rounded-md shadow-sm text-gray-800 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-1 sm:text-sm ${
